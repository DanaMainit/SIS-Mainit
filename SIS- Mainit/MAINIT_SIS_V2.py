...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT INFORMATION SYSTEM", font=("Bodoni MT Black", 30))
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Century Gothic",13,"bold"),bd=0, width = 10, bg="Maroon", fg="white", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblccode = Label(self, font=("Century Gothic", 12, "bold"), text="Course Code:", padx=5, pady=5)
        self.lblccode.place(x=125,y=144)
        self.txtccode = Entry(self, font=("Century Gothic", 13), textvariable=Course_Code, width=31)
        self.txtccode.place(x=270,y=150)

        self.lblcname = Label(self, font=("Century Gothic", 12,"bold"), text="Course Name:", padx=5, pady=5)
        self.lblcname.place(x=125,y=205)
        self.txtcname = Entry(self, font=("Century Gothic", 13), textvariable=Course_Name, width=31)
        self.txtcname.place(x=270,y=210)
        
        self.SearchBar = Entry(self, font=("Century Gothic", 11), textvariable=SearchBar_Var, bd=0,bg="Gray",width=31)
        ...
        self.adds = Button(self, text="ADD", font=('Century Gothic', 11, ), height=1, width=10, bd=1, bg="Maroon", fg="white",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Century Gothic', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Century Gothic', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Century Gothic', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Century Gothic', 11, 'bold'),bd=0, bg= "Maroon", fg="white", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Century Gothic', 11, 'bold'), height=1, width=11, bg="Maroon", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="REGISTRATION FORM ", font=("Century Gothic", 40))
        label.place(x=130,y=20)
        
        home = tk.Button(self, text="HOME",font=("Century Gothic",12,"bold"),bd=0, width = 7, bg="Maroon", fg="white",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.lblid = Label(self, font=("Century Gothic", 12,"bold"), text="ID Number:", padx=5, pady=5)
        self.lblid.place(x=125,y=144)
        self.txtid = Entry(self, font=("Century Gothic", 13), textvariable=Student_ID, width=33)
        self.txtid.place(x=255,y=150)

        self.lblname = Label(self, font=("Century Gothic", 12,"bold"), text="Name:", padx=5, pady=5)
        self.lblname.place(x=125,y=205)
        self.txtname = Entry(self, font=("Century Gothic", 13), textvariable=Student_Name, width=33)
        self.txtname.place(x=255,y=210)
        
        self.lblc = Label(self, font=("Century Gothic", 12,"bold"), text="Course Code:", padx=5, pady=5)
        self.lblc.place(x=125,y=269)
        self.txtyear = ttk.Combobox(self, value=["BS Stat", "BS Math", "BS IT", "BSCS","BSA","BS Bio","BS Chem","BSCE","BSHM","BS Micr","BSN","BA Hist","BA Phil","BA PoSc"], state="readonly", font=("Century Gothic", 12), textvariable=Course_Code, width=28)
        self.txtyear.place(x=255,y=274)
        

        self.lblyear = Label(self, font=("Century Gothic", 12,"bold"), text="Year Level:", padx=5, pady=5)
        ...
        self.txtgender = ttk.Combobox(self, value=["Male", "Female"], font=("Century Gothic", 13), state="readonly", textvariable=Student_Gender, width=28)
        ...
        self.add = Button(self, text="REGISTER", font=('Times New Roman', 11), height=1, width=10, bd=1,  bg="Maroon", fg="white", command=add_stud)
        self.add.place(x=150,y=420)
        self.add.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Times New Roman', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=update_stud)
        self.update.place(x=250,y=420)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Times New Roman', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=clear)
        self.clear.place(x=350,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Times New Roman', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=delete_stud)
        self.delete.place(x=450,y=420)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Times New Roman', 11, 'bold'),bd=0, bg= 'Maroon', fg="white", command=search_stud)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Times New Roman', 11, 'bold'), height=1, width=11,  bg="Maroon", fg="white",command = display_stud)
        self.display.place(x=575,y=105)
        self.display.config(cursor= "hand2")
