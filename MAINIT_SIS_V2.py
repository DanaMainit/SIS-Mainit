...
class Home(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="MSU-IIT STUDENT INFORMATION SYSTEM", font=("Lucida Console", 30))
        label.place(x=230,y=20)

        home = tk.Button(self, text="HOME",font=("Lucida Console",16,"bold"),bd=0, width = 10, bg="Maroon", fg="white", command=lambda: controller.show(Home))
        home.place(x=380,y=300)
        home.config(cursor= "hand2")
        
        course = tk.Button(self, text="COURSES",font=("Lucida Console",16,"bold"),bd=0, width = 10, bg="Maroon", fg="white", command=lambda: controller.show(Courses))
        course.place(x=568,y=300)
        course.config(cursor= "hand2")
        
        students = tk.Button(self, text="REGISTRATION",font=("Lucida Console",16,"bold"),bd=0, width = 13, bg="Maroon", fg="white", command=lambda: controller.show(Students))
        students.place(x=750,y=300)
        students.config(cursor= "hand2")

        students = tk.Button(self, text="EXIT",font=("Lucida Console",15,"bold"),bd=0, width = 10, bg="Maroon", fg="white", command=iExit)
...
class Courses(tk.Frame):
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Lucida Console",13,"bold"),bd=0, width = 10, bg="Maroon", fg="white", command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
        ...
        self.adds = Button(self, text="ADD", font=('Lucida Console', 11, ), height=1, width=10, bd=1, bg="Maroon", fg="white",command=add_course)
        self.adds.place(x=460,y=300)
        self.adds.config(cursor= "hand2")

        self.update = Button(self, text="UPDATE", font=('Lucida Console', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=update_course) 
        self.update.place(x=460,y=360)
        self.update.config(cursor= "hand2")

        self.clear = Button(self, text="CLEAR", font=('Lucida Console', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=clear)
        self.clear.place(x=460,y=420)
        self.clear.config(cursor= "hand2")

        self.delete = Button(self, text="DELETE", font=('Lucida Console', 11), height=1, width=10, bd=1, bg="Maroon", fg="white", command=delete_course)
        self.delete.place(x=460,y=480)
        self.delete.config(cursor= "hand2")

        self.search = Button(self, text="SEARCH", font=('Lucida Console', 11, 'bold'),bd=0, bg= "Maroon", fg="white", command=search_course)
        self.search.place(x=1160,y=100)
        self.search.config(cursor= "hand2")

        self.display = Button(self, text="DISPLAY", font=('Lucida Console', 11, 'bold'), height=1, width=11, bg="Maroon", fg="white", command=display_course)
...
class Students(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        home = tk.Button(self, text="HOME",font=("Lucida Console",12,"bold"),bd=0, width = 7, bg="Maroon", fg="white",  command=lambda: controller.show(Home))
        home.place(x=1,y=35)
        home.config(cursor= "hand2")
